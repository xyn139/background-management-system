                        ...
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                ...
                                <div class="toolbar-btn-action">
                                    <a class="btn btn-primary m-r-5" href="#!"data-toggle="modal" data-target="#editMenu" onclick="addMenu()"><i
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="menu" items="${menus}" varStatus="status">
                                            <tr>
                                                ...
                                                <td>${menu.Page_shows}</td>
                                                <td>${menu.icon}</td>
                                                <td>${menu.href}</td>
                                                <td>${menu.pName}</td>
                                                <td><fmt:formatDate  value="${menu.page_time}"  pattern="yyyy年MM月dd日 HH:mm:ss"></fmt:formatDate></td>
                                                <td>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" id="pid"
                                                                    ...
                                                                    <c:forEach var="pMenu" items="${firstMenu}">
                                                                        <option value="${pMenu.id}">${pMenu.pageShows}</option>
                                                                    </c:forEach>
                                                                </select>
                                                            </div>
                                                        </form>
...
<script type="text/javascript">
    ...
    function addMenu(){
        type=1;
        document.getElementById("menuFrom").reset();//重置表单
    }
    ...
    function saveMenu() {
        if (checkMenu()) {
            ...
            let pageShows = document.getElementById("title").value;
