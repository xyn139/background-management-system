                        ...
                        <c:forEach var="menu" items="${menuList}">
                            ...
                            <li
                                    <c:if test="${not empty menu.list}">
                                        ...
                                        <c:if test="${menu.id==-2}"> active open </c:if>"
                                    </c:if>
                        ...
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                ...
                                <div class="toolbar-btn-action">
                                    <a class="btn btn-primary m-r-5" href="#!"data-toggle="modal" data-target="#editUser" onclick="addUser()"><i
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="user" items="${userList}" varStatus="status">
                                            <tr>
                                                ...
                                                <td>${user.tel}</td>
                                                <td>${user.address}</td>
                                                <td><fmt:formatDate value="${user.creationTime}" pattern="yyyy年MM月dd日 HH:mm:ss"></fmt:formatDate></td>
                                                <td>
...
$.ajax({
    ...
    function addUser(){
        type=1;
        document.getElementById("userFrom").reset();//重置表单
    }
