                        ...
                        <c:forEach var="menu" items="${menuList}">
                            ...
                            <li
                                    <c:if test="${not empty menu.list}">
                                        ...
                                        <c:if test="${menu.id==3}"> active open </c:if>"
                                    </c:if>
                                ><a href="${not empty menu.href?(ctx.concat(menu.href)):"#!"}"><i class="${menu.icon}"></i>${menu.pageShows}
                            </a>
                                <ul class=" nav nav-subnav">
                                    <c:if test="${not empty menu.list}">
                                        <c:forEach var="menuItem" items="${menu.list}">
                                            <li <c:if test="${menuItem.id==3}"> class="active"</c:if> ><a
                                                    href="${ctx}${menuItem.href}">${menuItem.pageShows}</a></li>
                                        </c:forEach>
                                    </c:if>
                                </ul>
                            </li>
                        ...
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                ...
                                <div class="toolbar-btn-action">
                                    <a class="btn btn-primary m-r-5" href="#!"data-toggle="modal" data-target="#editBusiness" onclick="addBusiness()"><i
                                            class="mdi mdi-plus"></i> 新增</a>
                                    <a class="btn btn-success m-r-5" onclick="enableBusiness()" href="#!"><i class="mdi mdi-check"></i> 启用</a>
                                            ...
                                            <div class="modal-dialog" business="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title" id="exampleModalLabel">修改商铺信息</h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form>
                                                            <input type="hidden" id="id">
                                                            <div class="form-group">
                                                                <label for="name" class="control-label">商铺名：</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="brName" class="control-label">负责人：</label>
                                                                <input type="text" class="form-control" id="brName">
                                                            </div>
                                                            <div class="form-group">
...
$.ajax({
    ...
    function addBusiness(){
        type=1;
        document.getElementById("businessFrom").reset();//重置表单
    }
        ...
        $.ajax({
            ...
            data: {
                ...
                if (res.code == 200) {
                    ...
                    document.getElementById("brName").value = res.data.brName;
